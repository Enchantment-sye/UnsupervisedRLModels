...
class TrajectoryBatch(
    ...
    def __new__(cls, env_spec, observations, last_observations, actions,
        ...
        #                   (Box, Discrete, Dict)):
        #         flat_dim = getattr(env_spec.observation_space, 'flat_dim', np.prod(env_spec.observation_space.shape))
        #         if flat_dim != np.prod(first_observation.shape):
        ...
        #                   (Box, Discrete, Dict)):
        #         flat_dim = getattr(env_spec.observation_space, 'flat_dim', np.prod(env_spec.observation_space.shape))
        #         if flat_dim != np.prod(last_observations[0].shape):
        ...
        #                   (Box, Discrete, Dict)):
        #         flat_dim = getattr(env_spec.action_space, 'flat_dim', np.prod(env_spec.action_space.shape))
        #         if flat_dim != np.prod(first_action.shape):
