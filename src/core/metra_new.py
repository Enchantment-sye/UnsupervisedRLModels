...
from core.metra_logging import setup_logger as _setup_logger, log_diagnostics as _log_diagnostics, \
    eval_log_diagnostics as _eval_log_diagnostics, plot_log_diagnostics as _plot_log_diagnostics
from core.metra_evaluation import evaluate_policy as _evaluate_policy, \
    evaluate_finetune_policy as _evaluate_finetune_policy, evaluate_pretrain_policy as _evaluate_pretrain_policy, \
    calc_eval_metrics as _calc_eval_metrics
from core.metra_viz import plot_trajectories as _plot_trajectories, save_image_grid as _save_image_grid
...
class DRQ_METRAAgent:
    ...
    def setup_logger(self, log_dir):
        return _setup_logger(self, log_dir)
    ...
    def _evaluate_policy(self):
        return _evaluate_policy(self)

    def _evaluate_finetune_policy(self):
        return _evaluate_finetune_policy(self)



    def _evaluate_pretrain_policy(self):
        return _evaluate_pretrain_policy(self)

    def calc_eval_metrics(self, trajectories, is_skill_trajectories=True):
        return _calc_eval_metrics(self, trajectories, is_skill_trajectories=is_skill_trajectories)

    def log_diagnostics(self, pause_for_plot=False):
        return _log_diagnostics(self, pause_for_plot=pause_for_plot)

    def _log_eval_metrics(self):
        _eval_log_diagnostics(self)
        _plot_log_diagnostics(self)

    def eval_log_diagnostics(self):
        return _eval_log_diagnostics(self)

    def plot_log_diagnostics(self):
        return _plot_log_diagnostics(self)
    ...
    def _save_image_grid(self, trajectories, n_eval_skills, n_trajs_per_skill):
        return _save_image_grid(self, trajectories, n_eval_skills, n_trajs_per_skill)
